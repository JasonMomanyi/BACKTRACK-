Certainly! If you want to modify the watcher so that it doesn't reload the module whenever the file changes, you can remove the file watcher part from the script. Here's the modified script without the file watcher:
